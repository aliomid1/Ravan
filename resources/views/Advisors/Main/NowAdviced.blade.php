...
@php
    ...
    $Advisor_ConversationNot = \App\Models\Conversation::where('advisor_id' , $Advisor_id)->whereIn('status' ,
                    ...
                    <div class="table-email-list">
                        <div class="table-responsive" tabindex="1" style=" outline: none;">
                            <table class="table table-hover text-center">
                                ...
                                <tbody>
                                    @forelse($Advisor_ConversationNot as $item)
                                        <tr>
                                            <td>
                                                {{ $item->User ? $item->User->fullname : "کاربر حذف شده" }}
                                            </td>
